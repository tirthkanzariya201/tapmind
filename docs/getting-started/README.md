...
- **Product Managers** learning what TapMind delivers for clients
- **Project Managers** onboarding to the platform scope
- **Client Stakeholders** who need a clear, non-technical introduction
- **Support Teams** building a foundation before handling tickets
- **Developers** who want business context before integration work
...
| [What is Mediation?](./what-is-mediation.md) | Why publishers use mediation to coordinate multiple ad sources |
...
[What is TapMind](./what-is-tapmind.md) → [Dashboard Hierarchy](../configuration-management/dashboard-hierarchy.md) → [G-Sheet Automation](../operations/g-sheet-automation.md)
